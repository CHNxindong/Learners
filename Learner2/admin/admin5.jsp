				...
				<div>
					...
					<div class="a15">
						...
						<%
							...
							intPage = 1; 
							String sqlQuery = "select count(id) from res where type='final' order by id";      //count(jobid)就是计算总行数
						...
						<%
							String resultQuery = "select * from res where type='final' order by id desc";   
					...
					<div class="a46">
						<ul class="pagination">
							...
							<li><%if(Integer.parseInt(strPage) > 1){%><a href="admin5.jsp?page=<%=Integer.parseInt(strPage)-1%>">上一页</a><%}else{%><a href="admin5.jsp?page=<%=intPage%>">首页</a><%}%></li>
							<li><%if(Integer.parseInt(strPage) < intPageCount){%><a href="admin5.jsp?page=<%=Integer.parseInt(strPage) + 1%>">下一页</a><%}else{%><a href="admin5.jsp?page=<%=intPageCount%>">末页</a><%}%></li> 
						</ul>
					</div>
				</div>
			</div>		
